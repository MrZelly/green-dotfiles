...
# Ble is autoclomplete script a bit buggy but useful: https://github.com/akinomyoga/ble.sh
# source /home/zelly/git/ble.sh/out/ble.sh
...
bash_prompt() {
	...
	format_font SEPARATOR_FORMAT_4 $TSFC1 $TSBG2
	format_font SEPARATOR_FORMAT_5 $TSFC3 $TSBG3
	...
	local SEPARATOR_4=$SEPARATOR_FORMAT_4$TRIANGLE2
	local SEPARATOR_5=$SEPARATOR_FORMAT_5$TRIANGLE2
	...
	*)
	...
	PS1="$TITLEBAR\n\e[1;32m ┌──${SEPARATOR_5}${SEPARATOR_4}\e[1;30;102m  ${SEPARATOR_1}${PROMT_PWD}${SEPARATOR_3}\n\e[1;32m └─> ${PROMT_INPUT}"
